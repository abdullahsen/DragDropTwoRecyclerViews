...
class DragListener internal constructor(private val listener: Listener) : View.OnDragListener {
            ...
            DragEvent.ACTION_DROP -> {
                ...
                when (viewId) {
                    flItem, tvEmptyListTop, tvEmptyListBottom, rvTop, rvBottom -> {
                        ...
                        when (viewId) {
                            tvEmptyListTop, rvTop -> target = v.rootView.findViewById<View>(rvTop) as RecyclerView
                            tvEmptyListBottom, rvBottom -> target = v.rootView.findViewById<View>(rvBottom) as RecyclerView
                            else -> {
